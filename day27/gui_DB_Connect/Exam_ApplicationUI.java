...
public class Exam_ApplicationUI extends JFrame {

		// ui화면1
	public Exam_ApplicationUI() {
		super("창1");
		...
		f.setTitle("원서접수신청");
//		f.setSize(400,600);
		f.setBounds(750, 200, 400, 600);//x, y, width, height
		...
		RoundedButton b3=new RoundedButton("입력전에 꼭 누르기 불이익 있을수있음");
		...
		b1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String certDay[]= {"23-05-05","23-05-10","23-05-25"};//정해진 시험날짜 저장을 위해 배열 선언
				...
				else if(cert_name.equals("")  && (!(cert_name.equals(certName[0]))|| !(cert_name.equals(certName[1])) || !(cert_name.equals(certName[2])) || !(cert_name.equals(certName[3])) || !(cert_name.equals(certName[4]))))
				{	//빈칸일떄와 배열안에 있는 값이 아닐때 else if 조건을 실행시킴
					System.out.println("입력칸을 채워");
					JOptionPane.showMessageDialog(f, "올바른 값을 입력해주세요!!");
					
				}
				else if(cert_day.equals("") && (!(cert_day.equals(certDay[0])) || !(cert_day.equals(certDay[1])) || !(cert_day.equals(certDay[2]))))
				{
					System.out.println("입력칸을 채워");
					JOptionPane.showMessageDialog(f, "올바른 값을 입력해주세요!!");
				}
